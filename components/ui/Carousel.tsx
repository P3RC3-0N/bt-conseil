...
const Carousel: React.FC<CarouselProps> = ({
    ...
    const renderCard = (card: typeof allCards[0], index: number) => {
        ...
        switch (card.type) {
            case 'team':
                return <TeamCard data={card.data as TeamCardData} {...commonProps} />;
            case 'service':
                return <ServiceCard data={card.data as ServiceCardData} {...commonProps} />;
            case 'realisation':
                return <RealisationCard data={card.data as RealisationCardData} {...commonProps} />;
            case 'message':
                return <MessageCard data={card.data as MessageCardData} {...commonProps} />;
            case 'devis':
                return <DevisCard data={card.data as DevisCardData} {...commonProps} />;
            default:
                return null;
        }
    };
