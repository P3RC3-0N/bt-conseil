...
const Header: React.FC<HeaderProps> = ({
  ...
  // Fonction scroll smooth vers section
  const handleScrollToSection = (href: string, id?: string, isTitleClick = false) => {
